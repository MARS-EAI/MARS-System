...
const ServiceCard = ({ hoverBg, github, title, desc, path }: IServiceCard) => {
    ...
    return (
        ...
        >
            ...
            <div className={styles.info}>
                ...
                {
                    github && (
                        <div className={classNames(styles.linkBtn, styles.github)} onClick={() => { handleLink(github); }}>
